 ...
 */
uint16_t AD7689::toCommand(AD7689_conf cfg)
{
 ...
 */
float AD7689::calculateVoltage(uint16_t sample)
{
 ...
 */
uint8_t AD7689::getInputConfig(uint8_t polarity, bool differential)
{
    uint8_t res;
    if (differential)
    {
 ...
 */
float AD7689::getNegRef(float posR, uint8_t polarity)
{
 ...
 */
uint8_t AD7689::getRefSrc(uint8_t refS, float posR)
{
 ...
 */
float AD7689::getPosRef(uint8_t refS, float posR)
{
