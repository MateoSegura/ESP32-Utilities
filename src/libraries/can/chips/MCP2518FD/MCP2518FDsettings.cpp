...
uint32_t MCP2518FDSettings::sysClock(const Oscillator inOscillator)
{
...
MCP2518FDSettings::MCP2518FDSettings(const Oscillator inOscillator,
                                       const uint32_t inDesiredArbitrationBitRate,
                                       const DataBitRateFactor inDataBitRateFactor,
                                       const uint32_t inTolerancePPM) : mOscillator(inOscillator),
...
uint32_t MCP2518FDSettings::actualArbitrationBitRate(void) const
{
...
uint32_t MCP2518FDSettings::actualDataBitRate(void) const
{
...
bool MCP2518FDSettings::exactArbitrationBitRate(void) const
{
...
bool MCP2518FDSettings::exactDataBitRate(void) const
{
  if (mDataBitRateFactor == DataBitRateFactor::x1)
  {
...
bool MCP2518FDSettings::dataBitRateIsAMultipleOfArbitrationBitRate(void) const
{
...
uint32_t MCP2518FDSettings::ppmFromDesiredArbitrationBitRate(void) const
{
  const uint32_t TQCount = 1 /* Sync Seg */ + mArbitrationPhaseSegment1 + mArbitrationPhaseSegment2;
...
uint32_t MCP2518FDSettings::arbitrationSamplePointFromBitStart(void) const
{
...
uint32_t MCP2518FDSettings::dataSamplePointFromBitStart(void) const
{
...
uint32_t MCP2518FDSettings::CANBitSettingConsistency(void) const
{
...
uint32_t MCP2518FDSettings::ramUsage(void) const
{
  uint32_t result = 0;
  //--- TXQ
...
uint32_t MCP2518FDSettings::objectSizeForPayload(const PayloadSize inPayload)
{
