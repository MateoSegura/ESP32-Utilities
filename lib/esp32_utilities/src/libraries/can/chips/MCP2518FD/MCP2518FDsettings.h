...
#include "CANFD_DataBitRateFactor.h"

//----------------------------------------------------------------------------------------------------------------------
//  MCP2518FDSettings class
//----------------------------------------------------------------------------------------------------------------------

class MCP2518FDSettings {
...
//······················································································································
  ...
  public: MCP2518FDSettings (const Oscillator inOscillator,
...
//······················································································································
  ...
  public: MCP2518FDSettings (const Oscillator inOscillator,
                              ...
                              const uint32_t inTolerancePPM = 1000) :
  MCP2518FDSettings (inOscillator, inDesiredArbitrationBitRate, DataBitRateFactor (inDataBitRateFactor), inTolerancePPM) {
  }
